  ...
  return (
    <div>
        ...
        <div>
                ...
                <div className='absolute z-10 w-72 h-72 bg-blue  rounded-full right-24 top-36 mix-blend-multiply blur-xl opacity-50 animate-blob animation-delay-2000'></div>
        </div>
