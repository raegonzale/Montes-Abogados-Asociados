...
export const NavBar = () => {
  return (
    <>
    <ul className="text-skyBlue h-[34px] w-[574px] font-abc text-[1px] hidden xl:flex xl:text-[15px] 
    ...
    <span className="h-[34px] w-[230px] hidden xl:items-center  xl:flex xl:place-content-around xl:justify-around">
    ...
    <svg xmlns="http://www.w3.org/2000/svg" alt="menu" className="fill-skyBlue xl:hidden"  height="35" viewBox="0 -960 960 960" width="35"><path d="M120-240v-80h720v80H120Zm0-200v-80h720v80H120Zm0-200v-80h720v80H120Z"/></svg>
    </>
  )
}
