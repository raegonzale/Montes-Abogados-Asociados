...
export const ThirdArticle = () => {
  return (
    <div className="w-full mx-auto h-[600px] flex justify-center relative">
      ...
      <div className="relative w-full mx-auto justify-center h-[80px] bg-skyBlue">
        <div className="absolute top-2 left-52 text-white text-[80px] font-abc font-semibold  ">
          Confianza
        </div>
        <div className="absolute top-14 left-28 text-skyBlue text-[50px] font-abc font-semibold  ">
          Confianza
        </div>
      </div>
